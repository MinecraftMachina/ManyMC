...
This launcher is a fork of [PolyMC](https://github.com/PolyMC/PolyMC)), since the latter's launcher does not currently natively support arm64. To comply with MultiMC's licensing, this launcher was rebranded to ManyMC. To use the custom native libraries, a dedicated [meta package](https://github.com/MinecraftMachina/meta-multimc-arm64/) has been created.
